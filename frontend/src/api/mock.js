...
const MOCK = {
  ...
  voteOptions: [
    { id: "opt_a", event_id: "demo", libelle: "Artiste principal" },
    { id: "opt_b", event_id: "demo", libelle: "Meilleure performance" },
  ],

  qrCode: {
    billet_id: "billet_demo",
    qr_code: "PAYON-QR-billet_demo-XXXXX",
    statut: "valide",
  },
...
export function mockPaymentScenario() {
  ...
  if (raw === "failure" || raw === "failed" || raw === "error")
    return "failure";
  return "success";
}
